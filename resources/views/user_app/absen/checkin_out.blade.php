            ...
            <div class="w-2/3 space-y-4">
                ...
                <div class="space-y-4" id="masuk_view">
                    ...
                    <button onclick="upload()"
                        class="w-full bg-blue-500 hover:bg-blue-600 enabled:hover:bg-none enabled:bg-slate-500 mt-4 p-1 rounded-md text-white text-center cursor-pointer enabled:cursor-not-allowed"
                        id="absen-button" enabled>
