...
Route::get('/lihat-password', [ProfileController::class, 'lihatPassword'])->name('lihat-password');

Route::get('/verifikasi-pin', [ProfileController::class, 'showPinForm'])->name('verifikasi.pin');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('trashed', [DataGuruController::class, 'trashed'])->name('data-guru.trashed');
        Route::post('restore/{id}', [DataGuruController::class, 'restore'])->name('data-guru.restore');
        Route::post('force-delete/{id}', [DataGuruController::class, 'forceDelete'])->name('data-guru.force-delete');
    ...
    Route::middleware('auth:api')->group(function () {
        Route::get('/guru', [DataGuruController::class, 'index']); // Get all teachers
        Route::post('/guru', [DataGuruController::class, 'store']); // Add a new teacher
        Route::get('/guru/{id}', [DataGuruController::class, 'show']); // Get a teacher by ID
        Route::put('/guru/{id}', [DataGuruController::class, 'update']); // Update a teacher by ID
        Route::delete('/guru/{id}', [DataGuruController::class, 'destroy']); // Delete a teacher by ID
    });
